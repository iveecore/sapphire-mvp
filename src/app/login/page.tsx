    ...
    <div className="min-h-screen bg-[#faf9ff] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[420px]">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-[#1f1f26]">Welcome back</h1>
          <p className="text-sm text-[#6d6875] mt-1">Log in to your Sapphire account</p>
        </div>
        ...
        <div className="bg-white rounded-[1.75rem] shadow-[0_2px_24px_rgba(0,0,0,0.07)] border border-black/5 p-7">
          ...
          {oauthError && (
            <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 mb-5">
              {oauthError === 'oauth_cancelled' ? 'Sign-in was cancelled.' : 'Google sign-in failed. Please try again or use email.'}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-xs font-semibold uppercase tracking-[0.12em] text-[#6d6875]">Password</label>
                <a href="/forgot-password" className="text-xs text-[#7a4cf5] hover:underline">Forgot?</a>
              </div>
              <input
                type="password"
                value={password}
        ...
        <p className="text-center text-sm text-[#6d6875] mt-5">
          ...
          <a href="/signup" className="font-semibold text-[#7a4cf5] hover:underline">Sign up free</a>
        </p>
      </div>
    </div>
  )
